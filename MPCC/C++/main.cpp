...
int main() {
    ...
    std::ifstream iConfig("Params/Oval_3X80_fs/config_oval_3X80_fs.json");
    json jsonConfig;
    iConfig >> jsonConfig;
    ...
    State x0 = {track_xy.X(0),track_xy.Y(0),phi_0,jsonConfig["v0"],0,0,0,1.0,0,jsonConfig["v0"]};
    //for(int i=0;i<jsonConfig["n_sim"];i++)
    while(!(x0.X < 42 && x0.X > 40.0 && 6.0 < x0.Y))
    {
